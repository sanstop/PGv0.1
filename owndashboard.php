...
<html lang="en">
  <head>
    ...
    <!-- Morris Charts CSS -->
    <link href="incld/css/plugins/morris.css" rel="stylesheet">
    <!-- Custom Fonts -->
  ...
  <body>
      ...
      <div id="page-wrapper">
        <div class="row">
          ...
          <div class="page-header">
            ...
            <h5> <span class="label label-default">The best and only Rental App</span></h5>
  		  </div>
          </div>  <!-- /.col-lg-12 -->
        </div> <!-- /.row -->
        <div id="content-row">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-9 text-right">
                    <div style="font-size:20px; font-weight:bolder">4800</div>
                    <div>Expense Due (3 Days)</div>
                  </div>
                </div>
              </div>
              <a href="#">
            ...
            <div class="panel panel-green">
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-9 text-right">
                    <div style="font-size:20px; font-weight:bolder">12</div>
                    <div>New Tasks!</div>
                  </div>
                </div>
              </div>
            ...
            <div class="panel panel-yellow">
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-9 text-right">
                    <div style="font-size:20px; font-weight:bolder">49</div>
            ...
            <div class="panel panel-red">
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-9 text-right">
                    <div style="font-size:20px; font-weight:bolder">18000</div>
                    <div>Income Due (3 Days)</div>
                  </div>
                </div>
              </div>
              <a href="#">
    ...
    <script src="incld/js/plugins/morris/raphael.min.js"></script>
    <script src="incld/js/plugins/morris/morris.min.js"></script>
    <script src="incld/js/plugins/morris/morris-data.js"></script>
