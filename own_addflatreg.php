...
<form id="regflat" role="form" enctype="multipart/form-data" method="post" action="">
  ...
  <div class="form-group">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6">
        <label class="control-label sr-only" for="dthduedate">DTH Bill Due Date</label>  
        <div class="input-group">
          <input name="dthduedate" id="dthduedate" type="text" class="form-control" value="DTH Bill Due Date" />
          <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
        </div>
      </div>
    </div>
  ...
  <div class="form-group">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6">
        <label class="control-label sr-only" for="wifiduedate">Wifi Bill Due Date</label>  
        <div class="input-group">
          <input name="wifiduedate" id="wifiduedate" type="text" class="form-control" value="Wifi Bill Due Date" />
          <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
        </div>
      </div>
    </div>
  ...
  <div class="form-group">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6">
        <label class="control-label sr-only" for="maidcookduedate">Payment Due Date</label>  
        <div class="input-group">
          <input name="maidcookduedate" id="maidcookduedate" type="text" class="form-control" value="Payment Due Date" />
          <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
        </div>
      </div>
    </div>
  ...
  <div class="form-group">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6">
        <label class="control-label sr-only" for="maidcleanduedate">Payment Due Date</label>  
        <div class="input-group">
          <input name="maidcleanduedate" id="maidcleanduedate" type="text" class="form-control" value="Payment Due Date" />
          <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
        </div>
      </div>
    </div>
  ...
  <div class="form-group">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6">
        <label class="control-label sr-only" for="powerduedate">Power Bill Due Date</label>  
        <div class="input-group">
          <input name="powerduedate" id="powerduedate" type="text" class="form-control" value="Power Bill Due Date" />
          <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
        </div>
      </div>
    </div>
